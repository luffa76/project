        ...
        <section>
            ...
            <table style="width: 50%;">
                ...
                <tr>
                    <th>등록날짜</th>
                    <td>
                        <fmt:parseDate value="${board.insertDate}" pattern="yyyy-MM-dd'T'HH:mm" var="parsedDateTime" type="both" />
                ...
                <c:if test="${not empty board.updateDate}">
                    <tr>
                        <th>최종 수정 날짜</th>
                        <td>
                            <fmt:parseDate value="${board.updateDate}" pattern="yyyy-MM-dd'T'HH:mm" var="parsedDateTime2" type="both" />
            ...
            <div style="display: flex;">
                ...
                <c:if test="${board.writerId == USER.userId }">
                    <form action="${pageContext.request.contextPath}/boardUpdatePage" method="post">
                        <input type="hidden" name="boardId" value="${board.boardId}"/>
                        <button type="submit">수정</button>
                    </form>

                    <form action="${pageContext.request.contextPath}/boardDelete" method="post">
                        <input type="hidden" name="boardId" value="${board.boardId}"/>
